...
/**
 * This class is deprecated, I (Paul) removed all the functions that we were using and 
 * put them in the Utilities class.
 * Once we're 100% sure nothing here will ever be needed we should delete this class
 * and maybe rename Utilities to Tools.
 * 
 * @author 2011 Team 5
 *
 */
