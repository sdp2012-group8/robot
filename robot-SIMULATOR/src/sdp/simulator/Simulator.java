...
//				drawVector(new Vector2D(robot.getCoords()),  NNetTools.getSector(state_cm, i == 0, 120, 150, 20), true);
//				drawVector(new Vector2D(robot.getCoords()),  NNetTools.getSector(state_cm, i == 0, 150, -150, 20), true);
//				drawVector(new Vector2D(robot.getCoords()),  NNetTools.getSector(state_cm, i == 0, -150, -120, 20), true);
			}
		}
		// draw ball
