...
public class Simulator extends WorldStateProvider {
	...
	public final static double PITCH_WIDTH_CM = Utilities.PITCH_WIDTH_CM;
	public final static double PITCH_HEIGHT_CM = Utilities.PITCH_HEIGHT_CM;
...
//					(int)((robot.getFrontRight().getY()+dir_y)*IMAGE_WIDTH));
	...
	private void drawVector(Vector2D origin, Vector2D vector, boolean draw_point_in_end) {
		double ex = (origin.getX()+vector.getX())*IMAGE_WIDTH/Utilities.PITCH_WIDTH_CM, ey = (origin.getY()+vector.getY())*IMAGE_WIDTH/Utilities.PITCH_WIDTH_CM;
		drawLine(
				(int)(origin.getX()*IMAGE_WIDTH/Utilities.PITCH_WIDTH_CM),
				(int)(origin.getY()*IMAGE_WIDTH/Utilities.PITCH_WIDTH_CM),
				(int)(ex),
				(int)(ey));
