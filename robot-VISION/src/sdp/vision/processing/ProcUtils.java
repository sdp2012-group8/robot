...
public class ProcUtils {
	...
	public static Point2D.Double frameToNormalCoordinates(ImageProcessorConfig config,
		...
		return new Point2D.Double(x / config.getFieldWidth(), (y / config.getFieldHeight())*(WorldState.PITCH_HEIGHT_CM/WorldState.PITCH_WIDTH_CM));
	}
	...
	public static Point2D.Double normalToFrameCoordinates(ImageProcessorConfig config,
		...
		y *= config.getFieldHeight()*(WorldState.PITCH_WIDTH_CM/WorldState.PITCH_HEIGHT_CM);
