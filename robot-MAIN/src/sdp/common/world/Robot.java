...
public final class Robot {
	 ...
	 * @return
	 */
	public static double getTurningAngle(Robot me, Point2D.Double point) {
		Vector2D pointLocal = getLocalVector(me, new Vector2D(point));
		return GeomUtils.normaliseAngle(-me.getAngle() + pointLocal.getDirection());
	}
	...
	/**
	 * Converts local coordinate (generated by {@link getLocalVector}) to a table coordinate.
	 * @param robot
	 * @param localVector
	 * @return
	 */
