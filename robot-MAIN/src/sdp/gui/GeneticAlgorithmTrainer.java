...
public class GeneticAlgorithmTrainer {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 0) {
			try {
				spawnGnomeTerminal("java -cp ../robot-NXT/bin:lib/neuroph-2.6.jar:lib/encog-engine-2.5.0.jar:lib/jbox2d-library-2.1.2.2-jar-with-dependencies.jar:bin sdp.gui.GeneticAlgorithmTrainer dontOpenGnomeTerminal");
